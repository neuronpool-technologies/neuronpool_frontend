...
const Giveaway = () => {
  ...
  const { logged_in, principal, neuronpool_balance } = useSelector(
    (state) => state.Profile
  );
          ...
          <>
            <Button
              ...
              isDisabled={
                ...
                Number(neuronpool_balance) <= 0
              }
              isLoading={loading}
              onClick={onOpen}
            >
              {eligibility === "eligible" && Number(neuronpool_balance) > 0
                ? "Claim bonus"
                : eligibility === "eligible" && Number(neuronpool_balance) <= 0
                ? "Stake ICP to claim"
                : "Ineligible"}
